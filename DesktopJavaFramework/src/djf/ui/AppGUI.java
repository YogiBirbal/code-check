...
public class AppGUI {
    ...
    public static  boolean newpressed = false;
    ...
    public void setAppTitle(String appTitle) {
        ...
        primaryStage.setTitle( props.getProperty(APP_TITLE)+ " - " + appTitle);
    }
    ...
    public AppGUI(  Stage initPrimaryStage, 
		    String initAppTitle, 
		    AppTemplate app) throws IOException{
    ...
    private void initTopToolbar(AppTemplate app) {
        ...
        renameButton = initChildButton(fileToolbar,	RENAME_ICON.toString(),	    SAVE_TOOLTIP.toString(),	true);
        aboutButton = initChildButton(fileToolbar,	ABOUT_ICON.toString(),	    EXIT_TOOLTIP.toString(),	false);
   ...
   /**
    ...
    private void createWelcomeDialog(AppTemplate app) throws IOException {
        Stage primaryStage = new Stage();
        primaryStage.setTitle("Welcome to CodeCheck");
        BorderPane x = new BorderPane();
        newB = new Button("NEW CODE CHECK");
        ...
        //JsonObject json = loadJSONFile(f.getPath());
        //JsonString jsontitle = json.getJsonString("files_recent");
