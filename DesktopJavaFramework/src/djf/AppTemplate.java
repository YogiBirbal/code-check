...
import static djf.ui.AppGUI.newpressed;
import static djf.ui.AppGUI.recfile;
...
public abstract class AppTemplate extends Application {
	...
	//try {
		...
		buildAppComponentsHook();
                AppFileController fileController = new AppFileController(this);
                if(newpressed){
            fileController.handleNewRequest();
        }
                if(recfile != null){
                //    this.getFileComponent().loadData(this.dataComponent, recfile);
                }
